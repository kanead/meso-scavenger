function solvesegregationmodelatintermediateNF
...
tableofoutput.Properties.VariableNames(1:18)={'Time','Vultures','Jackals','Hyenas','Lions','Carrion 1','Carrion 2','Log10Carrion1','Log10Carrion2','JackalRemovalRate1','HyenaRemovalRate1','LionRemovalRate1','VultureRemovalRate1','DecayRate1','JackalRemovalRate2','HyenaRemovalRate2','LionRemovalRate2','DecayRate2'};
writetable(tableofoutput,'nf_0_5.csv');
