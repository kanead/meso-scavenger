...
elseif scenario==2
    ...
    KJ_input=0.5*0.35;KH_input=0.5*0.19;KL_input=0.5*0.05; p_input=2.26;
    csvfilename='halvedKs.csv';
end
...
tableofoutput.Properties.VariableNames(1:12)={'Time (days)','Vultures','Jackals','Hyenas','Lions','Carrion','Log10Carrion','JackalRemovalRate','HyenaRemovalRate','LionRemovalRate','VultureRemovalRate','DecayRate'};
